...
- Choices and their revision history are stored in Cloudflare D1. An anonymous recovery key is generated in the browser and held in local storage. The server stores a SHA-256 digest of that key as the record identifier. No voter records or recovery keys are included in this repository.
