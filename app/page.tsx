    ...
    <main className="shell">
      ...
      {!state ? (
        ...
        <section className="panel orientation-panel" aria-labelledby="orientation-title">
          ...
          <p className="muted small" style={{ padding: "0 24px 22px", margin: 0 }}>אפשר להמשיך בלי חשבון. הבחירות נשמרות במכשיר; <a href="/signin-with-chatgpt?return_to=%2F" target="_top">כניסה עם ChatGPT</a> תאפשר להמשיך גם במכשיר אחר.</p>
        </section>
      ) : <>
      ...
      <div className="account-message">
        {account ? `מחובר לחשבון ${account.email}. המפה נשמרת גם למכשיר הבא.` : <>מומלץ <a href="/signin-with-chatgpt?return_to=%2F" target="_top">להיכנס לחשבון</a> כדי להמשיך ממכשיר אחר. אפשר להמשיך בלי כניסה.</>}
      </div>
